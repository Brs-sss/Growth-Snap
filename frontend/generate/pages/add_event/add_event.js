          ...
          wx.showToast({
            ...
            success: function () {
              setTimeout(function () {
                ...
                if(new_page){
                  wx.navigateTo({
                    url: '/generate/pages/preview/preview_video/preview_video'+'?video_title='+video_title+'&category=video'+'&openid='+openid,
                  })//成功提交，返回上个页面
                }
                else
                {
          ...
          wx.showToast({
            ...
            success: function () {
              setTimeout(function () {
                if(new_page){
                  wx.navigateTo({
                    url: '/generate/pages/preview/preview'+'?title='+diary_title+'&category=diary'+"&cover="+cover_index+"&paper="+paper_index,
                  })//成功提交,前往preview页面
                }
                else{
                  var pages = getCurrentPages();
...
Page({
  ...
  handleSubmit(e){
    ...
    if(category=="timeline"){
      ...
      wx.navigateTo({
        url: '/generate/pages/timeline/timeline' + '?index=' + timeline_template + 
